...
<div class="container container-auth">
    <div class="row justify-content-center card-auth" style="padding-top: 15%">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center logoClass">{{ __('Registrar') }}</div>
                <div class="col-lg-12">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="wallet" type="text" class="form-control @error('wallet') is-invalid @enderror" name="wallet" value="{{ old('wallet') }}" required autocomplete="wallet" autofocus></textarea>
