...
<div class="row-3" style="margin: 65px; padding: 30px">
    <div class="col-lg-6" style="min-width: 100%">
        ...
        <div class="row justify-content-center" >
            ...
            @endif
            <button type="submit" class="btn btn-primary logoClass" style="width: 80px">
                            ...
                            <div class="row intro">
                                ...
                                <div class="col float-right align-self-end">
                                    @if ($product->status==1)
                                        ...
                                        {{ Form::submit('Más detalles', ['class' => 'btn btn-primary mb-5'])}}{{--debe de ser mas detalles, haciendo prueba para vista subastar--}}
                                        {{ Form::close() }}
